    ...
    #
        while 1:
            ...
            if data:
                ...
                if(inst == 'tr'):
                    self.stm_link.send("r090")
                
                
#                 'f010', 'b010'
#image rec: to start:'g000', 'l090' (we need to take picture, if we get 10, we move, if we get other legit classes, we stop)
        #except:	
